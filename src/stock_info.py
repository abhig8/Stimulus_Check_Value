...
tickers = ["TSLA", "GOOGL", "AAPL", "PTON", "FB", "AMZN", "NFLX", "BTC", "ETH", "DOGE", "XRP", "LTC"]

ticker_stock = {"TSLA": "TESLA", "GOOGL": "GOOGLE", "AAPL": "APPLE", "PTON": "PELOTON",
 "FB": "FACEBOOK", "AMZN": "AMAZON", "NFLX": "NETFLIX"}
...
prices_april = [130.19, 1210.41, 68.31, 31.99, 174.79, 2168.87, 396.72, 6861.21, 156.62, .0020, .1877, 41.20]
