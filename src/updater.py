...
def update_investment(ticker, investment_type):
	...
	c.execute('insert into investments (ticker, stock, price, updated, first_check, second_check, third_check) values (%s,%s,%s,%s,%s,%s,%s)', [ticker, investment, price, get_time(), get_first_check_val(ticker, price), 0, 0])
	conn.commit()
